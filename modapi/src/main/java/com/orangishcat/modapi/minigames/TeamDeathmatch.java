package com.orangishcat.modapi.minigames;

import basewindow.InputCodes;
import com.orangishcat.modapi.Minigame;
import com.orangishcat.modapi.menus.FixedText;
import com.orangishcat.modapi.menus.Scoreboard;
import com.orangishcat.modapi.tank.TankNPC;
import tanks.Game;
...
public class TeamDeathmatch extends Minigame
{
    ...
    public static final String[] coolItems = new String[]{
            "[Blaster,bullet_laser.png,5,0,2000,2000,bullet,laser,none,1.0,0,0.9,1,75.0,16.0,0.0,true,0.0,1,30.0]\n",
    ...
    protected void start()
    {
        ...
        if ((Game.game.window.textPressedKeys.contains(InputCodes.KEY_LEFT_SHIFT) && Game.game.window.textPressedKeys.contains(InputCodes.KEY_LEFT_CONTROL) || Math.random() < 0.1))
        {
            shopNPC.posX -= 50;
