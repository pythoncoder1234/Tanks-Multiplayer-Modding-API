...
import com.orangishcat.modapi.obstacle.ObstacleTrainTrack;
import tanks.Game;
import tanks.Level;
...
public class TankTrain extends Tank implements IAvoidObject
{
    ...
    public void draw()
    {
        ...
        if (Game.prevScreen != Game.screen && ModAPI.getGameInstance() != null)
            copyCustomTank();
    }
    ...
    public ObstacleTrainTrack getCurrentTrack()
    {
        ...
        Obstacle o = com.orangishcat.modapi.Game.getObstacle(x, y);
