...
import com.orangishcat.modapi.network.event.EventSyncField;
import com.orangishcat.modapi.network.event.EventUnregisterSyncedMap;
...
public class SyncedFieldMap
{
     ...
     * <ul>
     *  <li>the field's class is in {@link NetworkFieldUtils#supportedTypes supportedTypes}</li>
    ...
    public HashSet<String> putAllSupportedFields(String... excludedNames)
    {
        ...
        {
            if (ModAPI.listContains(f.getType(), NetworkFieldUtils.supportedTypes) && !ModAPI.listContains(f.getName(), excludedNames)
    ...
    public static class SyncedField
    {
        ...
        public void writeTo(ByteBuf b)
        {
            ...
            NetworkFieldUtils.writeFields(b, this, "val");
        }
        ...
        public static void readFrom(ByteBuf b)
        {
            ...
            NetworkFieldUtils.readFields(b, map.object, name);
        }
    }
}
