...
import com.orangishcat.modapi.gui.screen.ScreenOptionsOverlay;
...
import com.orangishcat.modapi.registry.RegistryMinigame;
...
import com.orangishcat.modapi.network.event.*;
...
public class ModAPI implements ModInitializer {
    ...
    public static ScreenGame getGameInstance()
    {
...
//        ObstacleTeleporter.exitCooldown = 100;
    ...
    {
        ModAPI.registerMinigame(TeamDeathmatch.class);
//        ModAPI.registerMinigame(GameMap.class);
    }
    ...
    public static void setUp()
    {
        ...
        NetworkEventMap.register(EventUnregisterSyncedMap.class);
        NetworkEventMap.register(EventSetLevelTimer.class);
    ...
    public static <T> boolean listContains(T item, T[] arr)
    {
    ...
    {
        IGame g = (IGame) getGameInstance();
        if (Objects.equals(state.music, Game.screen.music) && !(g != null && !Objects.equals(state.intro, g.getMusicState().intro)))
            return;
    ...
    public static List<Map.Entry<Tank, Double>> withinRange(double x, double y, double radius, SortOrder sortOrder)
    {
        ...
        for (MovableUtils m : Game.movables)
        {
    ...
    public static Level loadLevel(String levelString)
    {
        ...
        if (ModAPI.currentGame != null)
            ModAPI.currentGame.level = l;
    ...
    public static String capitalize(String s)
    {
        ...
        if (!(ModAPI.lessThan('A', s.charAt(1), 'Z') || ModAPI.lessThan('a', s.charAt(1), 'z')))
