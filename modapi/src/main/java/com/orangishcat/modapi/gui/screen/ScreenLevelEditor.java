...
import com.orangishcat.modapi.editor.EditorAction;
import com.orangishcat.modapi.editor.EditorButtons;
...
import tanks.gui.screen.leveleditor.OverlayConfirmSave;
...
public class ScreenLevelEditor extends Screen implements ILevelPreviewScreen
{
	...
	public void initialize()
	{
		if (!this.initialized)
		{
			...
			if (ScreenLevelEditor.currentPlaceable == Placeable.obstacle)
			{
			...
			else
			{
				for (int x = 0; x < Game.currentSizeX; x++)
				{
					for (int y = 0; y < Game.currentSizeY; y++)
					{
						...
						if (o == null || o.selectorCount() == 0 || !(o.selectors.get(0) instanceof StackHeightSelector))
							continue;
