package com.orangishcat.modapi.gui;

import com.orangishcat.modapi.DrawingUtils;
...
public abstract class ScreenElement
{
    ...
    public static class Notification extends ScreenElement
    {
        ...
        public static long lastNotifTime;
        ...
        public void draw(double prevSY)
        {
            ...
            DrawingUtils.drawPopup(x + 158 + addX, y + addY + sY / 2, 315, sY + 10, 5, 5);
    ...
    public static class CenterMessage extends ScreenElement
    {
        ...
        {
            int brightness = (ModAPI.getGameInstance() != null && Level.isDark()) ? 255 : 0;
            ...
            this.duration = duration;
            this.previous = CenterMessage.currentMessage != null;
        }
        ...
        public void draw()
        {
            ...
            if (this.age > this.duration)
                CenterMessage.currentMessage = null;
        }
    }
}
