...
public class FixedText extends FixedMenu
{
    ...
    public void draw()
    {
        ...
        double x = Game.game.window.fontRenderer.getStringSizeX(this.sizeX, this.styling.text) / 2;
        double y = Game.game.window.fontRenderer.getStringSizeY(this.sizeY, this.styling.text) / 2;
        ...
        if (this.shadowEffect && (this.sizeX * 3 >= 1 || this.sizeY * 3 >= 1))
        {
            ...
            if (this.posZ >= 0)
                Game.game.window.fontRenderer.drawString(this.posX - x + this.sizeX * 3, this.posY - y + this.sizeY * 3, this.sizeX, this.sizeY, this.styling.text);
            else
                Game.game.window.fontRenderer.drawString(this.posX - x + this.sizeX * 3, this.posY - y + this.sizeY * 3, this.posZ, this.sizeX, this.sizeY, this.styling.text);
        }
        ...
        if (this.posZ >= 0)
            Game.game.window.fontRenderer.drawString(this.posX - x, this.posY - y, this.sizeX, this.sizeY, this.styling.text);
        else
            Game.game.window.fontRenderer.drawString(this.posX - x, this.posY - y, this.posZ, this.sizeX, this.sizeY, this.styling.text);
    }
    ...
    public void setLocation()
    {
        ...
        switch (this.location)
        {
            ...
            case topLeft:
                ...
                if (Game.showSpeedrunTimer && ModAPI.getGameInstance() == null)
