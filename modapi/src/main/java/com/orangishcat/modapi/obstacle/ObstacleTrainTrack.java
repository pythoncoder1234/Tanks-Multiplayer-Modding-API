...
import com.orangishcat.modapi.rendering.ShaderTrainTrack;
import com.orangishcat.modapi.tank.TankTrain;
...
import static com.orangishcat.modapi.Game.dirX;
import static com.orangishcat.modapi.Game.dirY;
...
public class ObstacleTrainTrack extends Obstacle
{
    ...
    public ObstacleTrainTrack(String name, double posX, double posY)
    {
        ...
        if (!com.orangishcat.modapi.Game.disableObstacleShaders)
    ...
    public static boolean exists(Obstacle o)
    {
        ...
        return com.orangishcat.modapi.Game.getObstacle(o.posX, o.posY) == o;
    }
    ...
    public void setOrientation()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            if (x < 0 || x >= Game.currentSizeX || y < 0 || y >= Game.currentSizeY || !(com.orangishcat.modapi.Game.getObstacle(x, y) instanceof ObstacleTrainTrack))
                continue;

            setObstacleOrientation(((ObstacleTrainTrack) com.orangishcat.modapi.Game.getObstacle(x, y)), dirX[i], dirY[i]);
        }
