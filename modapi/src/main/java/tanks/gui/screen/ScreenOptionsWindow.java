...
public class ScreenOptionsWindow extends ScreenOptionsOverlay
{
    ...
    Button back = new Button(Drawing.drawing.interfaceSizeX / 2, Drawing.drawing.interfaceSizeY / 2 + this.objYSpace * 3.5, this.objWidth, this.objHeight, "Back", () -> Game.screen = new ScreenOptions());

    Button fullscreen = new Button(this.centerX, this.centerY, this.objWidth, this.objHeight, "", () -> Game.game.window.setFullscreen(!Game.game.window.fullscreen), "Can also be toggled at any time---by pressing " + Game.game.input.fullscreen.getInputs());

    Button maxFPS = new Button(this.centerX, this.centerY + this.objYSpace, this.objWidth, this.objHeight, "", () -> Game.screen = new ScreenOptionsFramerate(),
    ...
    public ScreenOptionsWindow()
    {
        ...
        height = new TextBox(Drawing.drawing.interfaceSizeX / 2 + this.objXSpace / 4, Drawing.drawing.interfaceSizeY / 2 - this.objYSpace, this.objWidth / 2, this.objHeight, "Height", () ->
        {
