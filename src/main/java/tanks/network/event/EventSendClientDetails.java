...
public class EventSendClientDetails extends PersonalEvent implements IServerThreadEvent
{
	...
	public static final HashMap<String, Long> joinedNames = new HashMap<>();
	...
	public void execute(ServerHandler s)
	{
		...
		if (Game.screen instanceof IPartyGameScreen)
		{
			...
			if (!joinedNames.containsKey(this.username) || System.currentTimeMillis() - joinedNames.get(this.username) > 5000)
			{
				joinedNames.put(this.username, System.currentTimeMillis());
