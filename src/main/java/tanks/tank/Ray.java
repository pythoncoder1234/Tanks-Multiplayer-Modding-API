...
public class Ray
{
	...
	public Movable getTarget()
	{
		...
		while (this.bounces >= 0 && this.bouncyBounces >= 0)
		{
			...
			if (result.collisionFace() != null)
			{
				...
				{
                    Movable m = (Movable) result.collisionFace().owner;
                ...
                if (result.collisionFace().owner instanceof Obstacle && ((Obstacle) result.collisionFace().owner).bouncy)
                    this.bouncyBounces--;
    ...
    public static final class Result
    {
        ...
        public boolean equals(Object obj)
        {
            ...
            return Double.doubleToLongBits(this.t) == Double.doubleToLongBits(that.t) &&
                   Double.doubleToLongBits(this.collisionX) == Double.doubleToLongBits(that.collisionX) &&
                   Double.doubleToLongBits(this.collisionY) == Double.doubleToLongBits(that.collisionY) &&
                   Objects.equals(this.collisionFace, that.collisionFace) &&
                   this.corner == that.corner;
        }

        @Override
        public int hashCode()
        {
            return Objects.hash(t, collisionX, collisionY, collisionFace, corner);
        }
