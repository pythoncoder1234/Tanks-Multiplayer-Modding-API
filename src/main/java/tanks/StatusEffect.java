...
public class StatusEffect
{
    ...
    public static final StatusEffect drown_damage = new StatusEffect("drowning_damage", new AttributeModifier[]{new AttributeModifier("drowning_damage", AttributeModifier.damage, AttributeModifier.Operation.add, 0.1)});
