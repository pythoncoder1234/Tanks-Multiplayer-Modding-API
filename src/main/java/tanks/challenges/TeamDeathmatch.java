...
public class TeamDeathmatch extends ModLevel
{
    ...
    public void setUp()
    {
        ...
        ModAPI.displayText(FixedText.types.title, "Team Deathmatch", false, 500, 255, 0, 0);
        ModAPI.displayText(FixedText.types.subtitle, "Kill all your enemies", false, 500, 255, 255, 255);
    }
}