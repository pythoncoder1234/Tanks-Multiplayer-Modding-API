...
public class EventPlayMusic extends PersonalEvent
{
    public String music = "";
    public float volume;
    ...
    public EventPlayMusic()
    {

    }

    public EventPlayMusic(String sound, float volume, boolean looped, String id, long fadeTime)
    {
        this.music = sound;
        this.volume = volume;
        this.looped = looped;
